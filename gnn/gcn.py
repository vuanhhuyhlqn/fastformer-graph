...
class StandGCN1(nn.Module):
    def __init__(self, nfeat, nhid, dropout, nlayer=1):
...
class StandGCN2(nn.Module):
    def __init__(self, nfeat, nhid, dropout, nlayer=2):
...
def create_gcn(nfeat, nhid, nclass, dropout, nlayer):
    if nlayer == 1:
        model = StandGCN1(nfeat, nhid, dropout, nlayer)
    elif nlayer == 2:
        model = StandGCN2(nfeat, nhid, dropout, nlayer)
    else:
        model = StandGCNX(nfeat, nhid, dropout, nlayer)
    return model
